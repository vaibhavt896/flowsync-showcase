              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {replayData.recreationGuide.map((step, index) => (
                ...
                <div className="mt-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    {replayData.insights.map((insight, index) => (
              ...
              >
                ...
                <div className="card p-6">
                  ...
                  <div className="space-y-4">
                    {archaeologyData.significantPatterns.map((pattern, index) => (
                      <div key={pattern.id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                        <div className="flex items-center justify-between mb-2">
                          <h7 className="font-medium text-gray-800 dark:text-gray-200">{pattern.name}</h7>
                ...
                <div className="card p-6">
                  ...
                  <div className="space-y-3">
                    {archaeologyData.deepInsights.map((insight, index) => (
            ...
            {trajectoryData && (
              ...
              >
                ...
                <div className="card p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      <h7 className="font-medium text-green-600 mb-2">Short-term Actions</h7>
                      <ul className="space-y-1">
                        {trajectoryData.recommendations.shortTerm.map((rec, index) => (
                    ...
                    <div>
                      <h7 className="font-medium text-blue-600 mb-2">Long-term Strategy</h7>
                      <ul className="space-y-1">
                        {trajectoryData.recommendations.longTerm.map((rec, index) => (
                          <li key={index} className="text-sm text-gray-700 dark:text-gray-300 flex items-start gap-2">
                    ...
                    <div>
                      <h7 className="font-medium text-orange-600 mb-2">Risk Mitigation</h7>
                      <ul className="space-y-1">
                        {trajectoryData.recommendations.riskMitigation.map((rec, index) => (
                          <li key={index} className="text-sm text-gray-700 dark:text-gray-300 flex items-start gap-2">
